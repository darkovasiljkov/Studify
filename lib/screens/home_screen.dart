...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Studify', style: AppConstants.headingStyle.copyWith(color: Colors.white)),
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Text(
              'Welcome Back!',
              style: AppConstants.headingStyle.copyWith(color: Colors.black87, fontSize: 32),
            ),
            SizedBox(height: 8),
            Text(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                feature['title'],
                style: AppConstants.buttonTextStyle.copyWith(fontSize: 14, color: Colors.white),
              ),
            ],
          ),
        ),
  ...
  final List<Map<String, dynamic>> featureList = [
    ...
    {'title': 'Tasks', 'icon': Icons.task, 'route': AppConstants.taskDetailsRoute},
